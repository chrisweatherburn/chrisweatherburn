...
#below line reorders the display by number of nurses
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            selectizeInput("states",
                           "States",
                           choice = unique_states,
                           selected = c("New York", "California", "Texas", "Pennsylvania", "Ohio", "Washington"),
                           multiple = TRUE),
            sliderInput("year",
                        "Year (map only)",
                        min = min(nurses$year),
        ...
        mainPanel(
            tabsetPanel(
                type = "tabs",
                tabPanel("Over Time", plotlyOutput("wages_plot")),
